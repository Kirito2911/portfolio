    ...
    <div className={styles.div1}>
       <div className={styles.div2}>
            <div className={styles.div21}>
                ...
                <p className={styles.textin}>Meu nome é Jean, tenho 19 anos e atualmente estou cursando Ciência da Computação. No tempo livre eu gosto de assistir animes ou jogar algum jogo. Tenho um pouco de conhecimento em C, Java, Python, Javascript, React, Angular e algumas outras coisas. Aqui estão alguns projetos acompanhados dos meus jogos favoritos.</p>
